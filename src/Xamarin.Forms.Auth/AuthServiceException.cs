...
namespace Xamarin.Forms.Auth
{
    ...
    public class AuthServiceException : AuthException
    {
        ...
        /// exception is specified.
        /// </param>
        public AuthServiceException(string errorCode, string errorMessage, int statusCode, string claims, Exception innerException)
        ...
        protected AuthServiceException(SerializationInfo serializationInfo, StreamingContext streamingContext)
...
#pragma warning disable CS1574 // XML comment has cref attribute that could not be resolved
        /// <summary>
        /// Gets additional claims requested by the service. When this property is not null or empty, this means that the service requires the user to
