...
#if iOS
using Xamarin.Auth.Forms.Platforms.iOS;
#endif
...
#pragma warning disable CS1574 // XML comment has cref attribute that could not be resolved
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>Contrary to <see cref="Xamarin.Auth.Forms.ConfidentialClientApplication"/>, public clients are unable to hold configuration time secrets,
